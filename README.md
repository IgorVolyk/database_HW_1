...
#### Нарушение 2НФ:
Были частичные зависимости - атрибуты товара (продуктовая линейка, класс, размер) зависели от product_id и бренда, а не от полного первичного ключа (transaction_id + product_id). Более того, один product_id мог относиться к разным брендам, что нарушало саму концепцию уникального идентификатора.
