...
- **customers** - основная демографическая информация (имя, фамилия, пол, дата рождения)
- **customer_job** - профессиональные данные (должность, отрасль деятельности)  
- **customer_financials** - финансовый профиль (сегмент благосостояния, наличие автомобиля, оценка недвижимости)
- **customer_addresses** - географические данные (адрес, регион, страна)

Такая структура позволяет:
- Сегментировать клиентов по финансовым и демографическим признакам
- Анализировать покупочную способность разных wealth_segment
- Строить географические отчеты по регионам и странам
- Отслеживать профессиональную принадлежность клиентов
